...
public class Tree_HotelReviews2 {
    static class Pair implements Comparable<Pair> {
        int rev;
        public int ind;

        public Pair(int rev, int ind) {
            this.rev = rev;
            this.ind = ind;
        }
        ...
        public int compareTo(Pair p2) {
            int t = Integer.compare(rev, p2.rev);
            if (t == 0) {
                return Integer.compare(ind, p2.ind);
            }
            return -t;
        }
    }
    ...
    public static ArrayList<Integer> solve(String A, ArrayList<String> B) {
        String[] arr_keywords = A.split("_");
        HashSet<String> s_keywords = new HashSet<>();
        ArrayList<Pair> ts = new ArrayList<>();
        ...
        for (int i = 0; i < B.size(); i++) {
            ...
            for (String word : words) {
                if (s_keywords.contains(word)){
                    score++;
                }
            }
            ts.add(new Pair(score, i));
        }
